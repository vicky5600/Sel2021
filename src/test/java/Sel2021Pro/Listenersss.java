...
public class Listenersss extends utilPage implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			exttss.get().addScreenCaptureFromPath(getScreenShots(testCase,driver),result.getMethod().getMethodName());
